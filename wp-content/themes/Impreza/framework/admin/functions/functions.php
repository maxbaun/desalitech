...
function us_enqueue_admin_css() {
	...
	wp_enqueue_style( 'us-js-composer', $us_template_directory_uri . '/framework/admin/css/js_composer.css' );
	wp_enqueue_style( 'us-metabox', $us_template_directory_uri . '/framework/admin/css/metabox.css' );
}
