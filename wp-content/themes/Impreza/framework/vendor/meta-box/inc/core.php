...
class RWMB_Core
{
	...
	{
		$links[] = '<a href="https://metabox.io/docs/">' . us_translate_with_external_domain( 'Documentation', 'meta-box' ) . '</a>';
		$links[] = '<a href="https://metabox.io/plugins/">' . us_translate_with_external_domain( 'Extensions', 'meta-box' ) . '</a>';
		return $links;
	}
