...
class RWMB_Image_Field extends RWMB_File_Field
{
	...
	{
		$i18n_title = apply_filters( 'rwmb_image_upload_string', us_translate_with_external_domain( 'Upload Images', 'meta-box' ), $field );
		$i18n_more  = apply_filters( 'rwmb_image_add_string', us_translate_with_external_domain( '+ Add new image', 'meta-box' ), $field );
	...
	{
		$i18n_delete = apply_filters( 'rwmb_image_delete_string', us_translate_with_external_domain( 'Delete', 'meta-box' ) );
		$i18n_edit   = apply_filters( 'rwmb_image_edit_string', us_translate_with_external_domain( 'Edit', 'meta-box' ) );
		$item        = '
			<li id="item_%s">
				<img src="%s" />
