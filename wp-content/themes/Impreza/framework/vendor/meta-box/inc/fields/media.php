...
class RWMB_Media_Field extends RWMB_Field
{
	...
	static function admin_enqueue_scripts()
	{
		...
		wp_localize_script( 'rwmb-media', 'i18nRwmbMedia', array(
			'add'                => apply_filters( 'rwmb_media_add_string', us_translate_with_external_domain( '+ Add Media', 'meta-box' ) ),
			'single'             => apply_filters( 'rwmb_media_single_files_string', us_translate_with_external_domain( ' file', 'meta-box' ) ),
			'multiple'           => apply_filters( 'rwmb_media_multiple_files_string', us_translate_with_external_domain( ' files', 'meta-box' ) ),
			'remove'             => apply_filters( 'rwmb_media_remove_string', us_translate_with_external_domain( 'Remove', 'meta-box' ) ),
			'edit'               => apply_filters( 'rwmb_media_edit_string', us_translate_with_external_domain( 'Edit', 'meta-box' ) ),
			'view'               => apply_filters( 'rwmb_media_view_string', us_translate_with_external_domain( 'View', 'meta-box' ) ),
			'noTitle'            => us_translate_with_external_domain( 'No Title', 'meta-box' ),
			'loadingUrl'         => RWMB_URL . 'img/loader.gif',
			'extensions'         => self::get_mime_extensions(),
			'select'             => us_translate_with_external_domain( 'Select Files', 'meta-box' ),
			'uploadInstructions' => us_translate_with_external_domain( 'Drop files here to upload', 'meta-box' )
		) );
	}
