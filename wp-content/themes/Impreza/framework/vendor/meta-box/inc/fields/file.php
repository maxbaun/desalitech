...
class RWMB_File_Field extends RWMB_Field
{
	...
	static function admin_enqueue_scripts()
	{
		...
		wp_localize_script( 'rwmb-file', 'rwmbFile', array(
			'maxFileUploadsSingle' => us_translate_with_external_domain( 'You may only upload maximum %d file', 'meta-box' ),
			'maxFileUploadsPlural' => us_translate_with_external_domain( 'You may only upload maximum %d files', 'meta-box' ),
		) );
	}
	...
	static function wp_ajax_delete_file()
	{
		...
		if ( $success )
			...
			wp_send_json_error( us_translate_with_external_domain( 'Error: Cannot delete file', 'meta-box' ) );
	}
	...
	{
		$i18n_title = apply_filters( 'rwmb_file_upload_string', us_translate_with_external_domain( 'Upload Files', 'meta-box' ), $field );
		$i18n_more  = apply_filters( 'rwmb_file_add_string', us_translate_with_external_domain( '+ Add new file', 'meta-box' ), $field );
	...
	{
		$i18n_delete = apply_filters( 'rwmb_file_delete_string', us_translate_with_external_domain( 'Delete', 'meta-box' ) );
		$i18n_edit   = apply_filters( 'rwmb_file_edit_string', us_translate_with_external_domain( 'Edit', 'meta-box' ) );
		$item        = '
		<li id="item_%s">
