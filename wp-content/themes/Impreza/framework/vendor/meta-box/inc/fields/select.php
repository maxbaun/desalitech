...
//		}
	...
	public static function get_select_all_html( $field )
	{
		...
		{
			return '<div class="rwmb-select-all-none">' . us_translate_with_external_domain( 'Select', 'meta-box' ) . ': <a data-type="all" href="#">' . us_translate_with_external_domain( 'All', 'meta-box' ) . '</a> | <a data-type="none" href="#">' . us_translate_with_external_domain( 'None', 'meta-box' ) . '</a></div>';
		}
		return '';
	}
}
